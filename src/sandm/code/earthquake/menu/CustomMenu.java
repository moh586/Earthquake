package sandm.code.earthquake.menu;
import java.util.ArrayList;

import sandm.code.earthquake.R;
...
public class CustomMenu {
	...
	public synchronized void show(View v) {
		...
		if (metrics.widthPixels > metrics.heightPixels) isLandscape = true;
        ...
        for (int i=0; i < mRows; i++) {
    		...
    		for (int j=0; j< divisor; j++) {
    			...
    			tv.setText(sandm.code.earthquake.shapeengin.PersianReshap.reshape(cmi.getCaption()));
    			tv.setTextSize(15);
